                    ...
                    "columns": [{
                        ...
                        },
                        {
                            "render": function(data, type, row) {
                                ...
                                var ID = row.id;
                                return `<div class="dropdown table-action"><a href="#" class="action-icon " data-bs-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a><div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" onclick="changeStatus('1', '${ID}')" href="javascript:void(0);">1. Approved</a><a class="dropdown-item" onclick="changeStatus('2', '${ID}')" href="javascript:void(0);">2. Rejected</a></div></div>`;
                            }
                        },
                        {
                            "render": function(data, type, row) {
                                ...
                                data.forEach(element => {
                                    employeeList += '<a class="dropdown-item" href="javascript:void(0);">'+ number +'. '+ element.name +' '+ element.last_name +'</a>';
                                    number++;
                                });

                                if(row['status'] == "1") {
                                    return `<div class="dropdown table-action"><a href="#" class="action-icon " data-bs-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a><div class="dropdown-menu dropdown-menu-right"> ${employeeList} </div></div>`;
                                } else {
                                    return '-';
                                }
