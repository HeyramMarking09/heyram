                                                ...
                                                <div class="card card letter-head text-left mb-0 bg-black" style="color: #fec917;">
                                                    <div class="card-body">
                                                        <div class="row">
                                                            ...
                                                            {{-- </div> --}}
                                                            {{-- <h2 style="color: white; margin-left: 120px; margin-top: 10px;">Retainer Agreement</h2> --}}
                                                        </div>
                                                        <h3 style="color: white; margin-top: -48px; margin-left: 57px;">Retainer Agreement</h3>
                                                    </div>
                                                </div>
                                                <div class="card-body">
                                                    <div id="basic-pills-wizard" class="twitter-bs-wizard">
