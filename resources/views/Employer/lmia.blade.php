                    ...
                    <div class="card shadow-sm">
                        <div class="card-body">
                            <form id="lmia-form">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-xl-6">
                                                                ...
                                                                <div class="col-lg-12">
                                                                    <input type="text" placeholder="m/d/Y" name="start_date_0" required class="form-control datepicker-data">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    <label class="col-lg-9 col-form-label fw-bold">Total number of Canadian Citizen/ Permanent Residency in the same occupation in which LMIA is requested.</label>
                                    <div class="col-lg-6">
        ...
        $(document).ready(function() {
            $("#lmia-form").validate({
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        url: "{{ route('employer.lmia-form') }}", // Your endpoint to handle form submission
                        method: 'POST',
