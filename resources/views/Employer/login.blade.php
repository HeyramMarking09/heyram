    ...
    <div class="main-wrapper">
        <div class="account-content">
            <div class="login-wrapper">
                    ...
                    <form id="loginForm">
                        ...
                        <div class="login-user-info">
                            ...
                            <div class="form-wrap form-wrap-checkbox">
                                <div class="text-end">
                                    <a href="forgot-password-2.html" class="forgot-link">Forgot Password?</a>
                                </div>
                            </div>
                            <div class="form-wrap">
                ...
                <div class="login-img">
                    <img src="{{ asset('assets/img/authentication/login-img.png') }}" class="img-fluid" alt="Login">
                </div>
            </div>
        </div>
