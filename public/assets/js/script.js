...
$(document).ready(function () {
	...
	$(document).on('click', '.add-sign', function () {
		...
		var signcontent = `
			<div class="row sign-cont">
				<div class="col-md-6">
					<div class="form-wrap">
						<label class="col-form-label">Job Title/Occupation</label>
						<input class="form-control" type="text" name="job_title_occupation[]" placeholder="Enter Job Title/Occupation">
					</div>
				</div>
				<div class="col-md-6">
					<div class="d-flex align-items-center">
						<div class="float-none form-wrap me-3 w-100">
							<label class="col-lg-3 col-form-label">Is the person currently working?</label>
							<div class="col-lg-9">
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="radio" name="is_the_person_currently_working_${uniqueId}" value="1">
									<label class="form-check-label">Yes</label>
								</div>
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="radio" name="is_the_person_currently_working_${uniqueId}" value="0">
	...
	// Add Sign Lmia
	$(document).on('click', '.trash-sign-lmia', function () {
		$(this).closest('.sign-cont-lmia').remove();
		return false;
	});
	$(document).on('click', '.add-sign-lmia', function () {
		var uniqueId = Date.now();
		var signcontent = `
			<div class="row sign-cont-lmia">
				...
				<div class="col-md-6">
					<div class="row mb-3">
						...
						<div class="col-lg-12">
							<input type="text" required class="form-control" name="job_title_${uniqueId}">
						</div>
					</div>
					<div class="row mb-3">
						<div class="col-xl-6">
							...
							<div class="col-lg-12">
								<input type="text" class="form-control" name="employee_name_${uniqueId}" required>
							</div>
						</div>
						<div class="col-xl-6">
							<label class="col-lg-12 col-form-label fw-bold">Current job title</label>
							<div class="col-lg-12">
								<input type="text" class="form-control" name="current_job_title_${uniqueId}" required>
							</div>
						</div>
					</div>
						<div class="row mb-3">
							<div class="col-xl-6">
								...
								<div class="col-lg-12">
									<input type="number" name="current_pay_${uniqueId}" required min="0" class="form-control">
								</div>
							</div>
							<div class="col-xl-6">
					...
					<div class="input-btn form-wrap">
						<a href="javascript:void(0);" class="trash-sign-lmia" style="color:red"><i class="ti ti-trash"></i>Remove</a>
					</div>
				</div>
			</div>`;
		$(".sign-content").append(signcontent);
